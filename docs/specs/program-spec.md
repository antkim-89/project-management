...
- **진행률 및 비용 관리**: 수주 금액 대비 실제 인력 투입 상태를 추적하여 관리 효율성을 높입니다.
- **활동 로그 및 타임라인**: 프로젝트에 발생한 멤버 배정, 최종 갱신 등 중요 시스템 변경 이력을 실시간 타임라인으로 노출합니다.
...
3. **PROJECT**: 프로젝트 제목, 상태, 수주 금액 및 기간 정보
