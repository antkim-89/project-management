...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-primary text-on-primary hover:bg-primary/90 active:scale-[0.98] shadow-sm hover:shadow-md shadow-primary/20",
  secondary:
    "bg-secondary text-on-secondary hover:bg-secondary/90 active:scale-[0.98] shadow-sm hover:shadow-md shadow-secondary/20",
  error:
    "bg-error text-on-error hover:bg-error/90 active:scale-[0.98] shadow-sm hover:shadow-md shadow-error/20",
  ghost:
    "bg-transparent text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface active:bg-surface-container-highest",
  glass:
